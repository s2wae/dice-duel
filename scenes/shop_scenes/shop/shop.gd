...
const SHOP_UNIT_CARD = preload("res://scenes/shop_scenes/shop_ui_elements/shop_slots/unit_shop_slot/shop_slot.tscn")
const SHOP_DICE_CARD = preload("res://scenes/shop_scenes/shop_ui_elements/shop_slots/dice_shop_slot/dice_shop_slot.tscn")
